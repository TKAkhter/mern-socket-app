...
//   otp: yup.string("Enter your email").required("Email is required"),
//   new_password: yup.string("Enter your email").required("Email is required"),
              ...
              {step === 1 ? (
                ...
                >
                  <TextField
                    ...
                    error={
                      formikStep2.touched.email &&
                      Boolean(formikStep2.errors.email)
                    }
                    helperText={
